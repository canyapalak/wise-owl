    ...
    if (score >= 0 && score <= 2) {
      ...
      return (
        <p className="text-justify px-3">
          ...
          definitely more than just a ball of yarn rolling around. Your
          curiosity is as boundless as a cat exploring a room full of mysterious
          shadows and fascinating objects. And just like a playful cat chasing
          after a laser pointer, you're catching on to this quiz game with
          agility and charm.
        </p>
      );
    } else if (score > 4 && score <= 6) {
      ...
      return (
        <p className="text-justify px-3">
          ...
          not just any fox; you're the quiz master's elusive enigma. Much like a
          fox weaving through the forest, you navigate the questions with a dash
          of strategy and a twinkle in your eye. Embrace your canny nature, and
          continue to outsmart the challenges that come your way.
        </p>
      );
    } else {
      return (
